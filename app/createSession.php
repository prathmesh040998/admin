            ...
            <div class="col-sm-6">
                ...
                <form id="frmSession">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-form-label">Stud</label>
                            <div class="col-sm-10">
                              
                                 <select class="form-control  name='student_id' id=student required multiple size = 6" >;
                                 <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" id="meeting-time" name="sessionTime" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" id="meeting-time" name="room_id" value="<?= $uuid ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto my-1">
                        <button id="btnSaveSession" type="submit" class="btn btn-primary">Submit</button>
                    </div>
                </form>
